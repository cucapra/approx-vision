...
//    int height = 4;
    ...
    Image<float> opencv_in_image = scale.realize(width, height, 3);
    ...
    Image<float> scratch = Image2Func.realize(width,height,3);

    Func clamped("clamped");
    clamped = BoundaryConditions::repeat_edge(opencv_out);

    Func demosaic = make_demosaic_subsample ( &clamped );
    Image<float> scratch2 = demosaic.realize(width,height,3);

    // Scale back to 0-255 and represent in 8 bit fixed point
    Func descale            = make_descale      ( &demosaic );

 
    printf("%f %f\n"  ,scratch(2,4,0),scratch(3,4,0));
    printf("%f %f\n"  ,scratch(2,3,0),scratch(3,3,0));
    printf("%f %f\n\n",scratch(2,2,0),scratch(3,2,0));

    printf("%f %f\n"  ,scratch2(2,4,0),scratch2(3,4,0));
    printf("%f %f\n"  ,scratch2(2,3,0),scratch2(3,3,0));
    printf("%f %f\n\n",scratch2(2,2,0),scratch2(3,2,0));
