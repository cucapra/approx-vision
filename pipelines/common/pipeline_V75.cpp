...
int main(int argc, char **argv) {
  ...
  int height = input.height();
    ...
    Func qrtr_res_binning_1 = make_qrtr_res_binning ( &demosaic );

    Func qrtr_res_binning_2 = make_qrtr_res_binning ( &qrtr_res_binning_1 );

    Func qrtr_res_binning_3 = make_qrtr_res_binning ( &qrtr_res_binning_2 );

    Func tone_map           = make_tone_map     ( &qrtr_res_binning_3,
                                                  &rev_tone_h );
  ...
  // Use JIT compiler
  descale.compile_jit();
  Image<uint8_t> output = descale.realize(width/8,height/8,3);
