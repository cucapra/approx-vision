...
// 
// Stages:
// lloydrequant, qrtrresbinning, pwltonemap
...
int main(int argc, char **argv) {
  ...
  int height = input.height();
    ...
    // forward
    Func qrtr_res_binning   = make_qrtr_res_binning ( &Image2Func );

    Func pwl_tone           = make_pwl_tone_map ( &qrtr_res_binning );


    // Scale back to 0-255 and represent in 8 bit fixed point
    Func descale            = make_descale      ( &pwl_tone );
