...
print("")
print("Current mirror power consumption (W)")
print(dc_pow)
print("Switching power consumption (W)")
print(ac_pow)
print("ADC power consumption (W)")
print(adc_pow)
print("")
print("Total power (W)")
print(tot_pow)
print("Energy per frame (J)")
print(e_per_f)
print("")
