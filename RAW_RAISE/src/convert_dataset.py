...
def preprocess_image(input_file, output_file, num_bits):
  command = [PREPROCESS_CONVERT_SCRIPT, input_file, output_file, num_bits]
  execute(command)
...
if __name__ == "__main__":
  ...
  for i, (name, bit) in enumerate(images):
    ...
    output_file = PNG_OUTPUT_DIR + name + ".png"
    preprocess_image(input_file, output_file, bit)
